<template>
    <div class="vue-datepicker">
        <input @click.stop="selectYear=!selectYear" :value="current | dateFormat" type="text" readonly style="width: 220px;text-align:center;">
        <div v-if="selectYear" class="vue-datepicker-wrap" style="position: absolute;z-index: 3;">
        ...
        methods: {
            ...
            */
            ...
            complete() {
                ...
                this.$store.commit('change_year',this.select.year)
                this.$store.commit('change_month',this.select.month)
                this.current = {
